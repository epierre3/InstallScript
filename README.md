...
```
sudo wget https://raw.githubusercontent.com/epierre3/InstallScript/13.0/odoo_install.sh
```
...
```
Download script
sudo wget https://raw.githubusercontent.com/epierre3/InstallScript/13.0/nginx_install.sh
...
```
Download script
sudo wget https://raw.githubusercontent.com/epierre3/InstallScript/13.0/certbot_install.sh
...
```
Download script
sudo wget https://raw.githubusercontent.com/epierre3/InstallScript/13.0/firewall_install.sh
